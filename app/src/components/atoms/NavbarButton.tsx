...
const NavbarButton = ({ children, image } : Props) => {
    ...
    return (
        <div>
            <button onClick={() => setIsExpanded(!isExpanded)} className="cursor-pointer flex items-center p-1 dark:hover:bg-gray-700 border-black hover:scale-105 transition-all duration-300 ease-in-out rounded-t-md space-x-3 rtl:space-x-reverse border shadow-[0_2px_0_0_black] hover:shadow-[0_8px_0_0_black]">                
            ...
            <div className={`
                absolute left-0 top-full w-full flex flex-col p-2 bg-gray-900
                 rounded-md mt-4 z-50 transition-all duration-300
                ${isExpanded
