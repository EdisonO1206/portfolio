...
const Footer = () => {
    return (
        <div className='bg-white dark:bg-gray-900 hover:border-t border-blue-600'>
            <div className="flex flex-row justify-between text-xl p-4 items-center">
                <div>&copy; Todos los derechos reservados</div>
                <div className="flex flex-row justify-evenly w-1/3">
                    {/* link to github */}
                    <Link href={""} target="_blank" className="hover:bg-gray-800 hover:text-blue-600 transition-all p-0.5 rounded-sm" title="Github">
                    ...
                    {/* link to instagram */}
                    <Link href={"https://www.instagram.com/eop._.69/"} target="_blank" className="hover:bg-gray-800 hover:text-pink-600 transition-all p-0.5 rounded-sm" title="Instagram">
                    ...
                    {/* link to whatsapp */}
                    <Link href={"https://wa.me/573026357194"} target="_blank" className="hover:bg-gray-800 hover:text-green-600 transition-all p-0.5 rounded-sm" title="Whatsapp">
