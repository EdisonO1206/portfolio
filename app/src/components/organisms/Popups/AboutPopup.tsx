    ...
    return (
        <PopupBase>
            <div className='flex justify-between border-b pb-4 mb-4'>
                <Title titleA="<Sobre " titleB="Mi/>" subTitle="" titleClassName="text-3xl text-xl md:text-5xl" changeColorOnHover={true}></Title>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div key={i} className="
                    col-span-1 bg-gray-950 border border-gray-800 rounded-md p-5 font-mono text-sm 
                    shadow-inner shadow-green-900/30 hover:shadow-lg 
                    hover:shadow-green-500/20 transition-all duration-500 relative
                ">
